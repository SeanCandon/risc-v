	...
	function execute(thread) {
		...
		while (1) {
			...
			case 125:
				...
				if (!(!(instrIsMulti($g[140].vIns) && $g[202]==0))) {
					$pc = 130
					continue
				}
			...
			case 154:
				...
				$pc = 155
			case 155:
				$stack[$fp+4]=booth($stack[$fp+4], $stack[$fp+5])
			...
			case 181:
				...
				$g[154].txtOp.setTxt($g[207].toString())
				$g[154].txtOp.setOpacity(1)
				$pc = 183
				continue
			case 182:
