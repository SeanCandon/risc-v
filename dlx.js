	...
	function execute(thread) {
		...
		while (1) {
			...
			case 5:
				...
				$g[167].addPoint(590, 70)
				$g[168] = new AnimPipe()
				$g[168].addPoint(590, 330)
				$g[168].addPoint(600, 330)
				$g[168].addPoint(600, 70)
				$g[169] = new AnimPipe()
				$g[169].addPoint(610, 70)
			...
			case 269:
				...
				fork(44, $g[72], ($g[26]==PIPELINING_ENABLED) ? 80 : 400)
				callf(262, $obj)
				continue
			case 270:
