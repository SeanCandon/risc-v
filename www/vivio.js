...
function VPlayer(canvasID, VCode, args) {
	...
	Arc.prototype.restoreState = function() {
		...
		this.spanAngle =	this.savedState.spanAngle;	// {joj 13/4/18}
		this.startAngle = this.savedState.startAngle;	// {joj 13/4/18}
	}
	...
	Arc.prototype.saveState = function() {
		...
		this.savedState.spanAngle = this.spanAngle;		// {joj 13/4/18}
		this.savedState.startAngle = this.startAngle;	// {joj 13/4/18}
	}
...
//									addToAsyncEventQ(new AsyncEvent(tick, callEventHandler.bind(null, handler[k].pc, handler[k].obj, down, flags, x, y)));
	...
	this.Font = Font;
	this.fork = fork;
	this.fromCodePoint = fromCodePoint;	// {joj 27/3/18}
